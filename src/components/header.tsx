    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-jestr-background/95 backdrop-blur supports-[backdrop-filter]:bg-jestr-background/60">
      <div className="container flex h-16 items-center justify-between mx-auto px-4 sm:px-6">
        <div className="flex items-center gap-2">
          <Link href="/">
            <span className="font-pixel text-2xl sm:text-3xl md:text-4xl text-jestr-yellow">
              JESTR.WORLD
            </span>
          </Link>
        </div>
    ...
    <div className="flex items-center gap-1">
      ...
      >
        <Button
          variant="ghost"
          size="icon"
          className="text-white hover:text-jestr-blue/80 h-8 w-8 sm:h-10 sm:w-10"
        >
      ...
      >
        <Button
          variant="ghost"
          size="icon"
          className="text-jestr-purple hover:text-jestr-purple/80 h-8 w-8 sm:h-10 sm:w-10"
        >
